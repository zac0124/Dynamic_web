 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="product_women.php"</script>';  
           }  
      }  
      else  
      {  
 ...
 <section id= "shop">
            <section class="shop-page-container">
                ...
                <div class="table-content">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><a href="product_women.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
                ...
                <div class="shop-details">   
                        <?php  
                        $query = "SELECT * FROM women_productdetail ORDER BY id ASC";  
                ...
                <div class = "product-details">
                    ...
                    <form method="post" action="product_women.php?action=add&id=<?php echo $row["id"]; ?>">  
