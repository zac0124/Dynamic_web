...
if(!isset($_SESSION['admin_email'])){
    ...
    $get_products = "select * from productdetail";
    
    $run_products = mysqli_query($conn,$get_products);
    
    $count_products = mysqli_num_rows($run_products);
    
    $get_customers = "select * from register";

    $run_customers = mysqli_query($conn,$get_customers);
    
    $count_customers = mysqli_num_rows($run_customers);
    
    $get_p_categories = "select category from productdetail";
    
    $run_p_categories = mysqli_query($conn,$get_p_categories);
    
    $count_p_categories = mysqli_num_rows($run_p_categories);
    
    $get_pending_orders = "select * from cart";
