...
var comment= document.getElementByComment("comment").value; 
...
if (checkNumSurvey(document.getElementById("num1"))) {
  if (checkNumSurvey(document.getElementById("num2"))) {
    if (checkNumSurvey(document.getElementById("num3"))) {
      if (checkNumSurvey(document.getElementById("num4"))) {
        if (checkNumSurvey(document.getElementById("num5"))) {
          if (checkNumSurvey(document.getElementByComment("comment"))) {
